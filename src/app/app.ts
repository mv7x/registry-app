...
export class App {
  ...
  startEdit(record: FormRecord): void {
    ...
    this.form.controls.arabicName.updateValueAndValidity();
    this.form.controls.englishName.updateValueAndValidity();
    this.form.controls.department.updateValueAndValidity();
    this.form.controls.submissionDeadline.updateValueAndValidity();
  ...
  sanitizeArabic(event: Event): void {
    const input =
      event.target as HTMLInputElement;
    ...
    this.form.controls.arabicName.setValue(
      cleaned
    );
  }

  sanitizeEnglish(event: Event): void {
    const input =
      event.target as HTMLInputElement;
    ...
    this.form.controls.englishName.setValue(
      cleaned
    );
  }
